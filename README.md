...
2. In the source enter `http://127.0.0.1:8080/slots.html?stream&goalie` or `http://127.0.0.1:8080/slots.html?stream&forward` if you want to roll forward gear options instead.  There isn't a super easy way to switch this but I'll work on that.  **Note: after connecting the source you may type "goalie" or "forward" into the terminal to swap to goalie or forward gear options.
